...
echo "🚀 Setting up Niv Realtime Database Tables..."
echo "================================================"
...
echo ""
echo "⚠️  IMPORTANT: Please run the following SQL in your Supabase Dashboard:"
...
echo "================================================"
echo ""
echo "After running the SQL, you also need to:"
echo "1. Go to Database > Replication"
echo "2. Enable realtime for these tables:"
echo "   - niv_artifacts"
echo "   - niv_conversations"
echo "   - niv_workspace_edits"
echo ""
echo "3. Set the CLAUDE_API_KEY secret in your edge function:"
echo "   supabase secrets set CLAUDE_API_KEY=your-key-here"
