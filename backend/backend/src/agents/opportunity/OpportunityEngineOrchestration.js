...
class OpportunityEngineOrchestrator {
  ...
  getModelForAgent(agentType) {
    ...
    const modelMap = {
      'research-optimizer': 'claude-3-opus-20240229',
      'data-analyst': 'claude-3-sonnet-20240229',
      'search-specialist': 'claude-3-haiku-20240307',
      'query-clarifier': 'claude-3-haiku-20240307',
      'task-decomposition-expert': 'claude-3-sonnet-20240229',
      'report-generator': 'claude-3-sonnet-20240229'
    };
    
    return modelMap[agentType] || 'claude-3-haiku-20240307';
  }
