...
- APIs: Supabase Edge Functions
  ...
  📅 Build time: 2025-08-29T17:05:32.846Z
  ...
  - window.checkCacheContamination() - Check for issues
    ...
    ⚡⚡⚡ RAILWAY V2 NEON INTERFACE v3.1.0 - DEPLOYED: 2025-08-29T17:05:32.851Z
    ...
    ✅ Loaded organization from localStorage: OpenAI
    🔄 Reset pipeline for new organization: OpenAI
    🔍 Checking Supabase for existing data for OpenAI...
    📊 Loading complete analysis for OpenAI from Supabase...
    ...
    🚀 V4 Elite Analysis starting for OpenAI, Stage: Organization Data Extraction
    ...
    🚀 V4 Elite Analysis starting for OpenAI, Stage: Competitive Intelligence Analysis
    ...
    🚀 V4 Elite Analysis starting for OpenAI, Stage: Stakeholder Analysis
    ...
    🚀 V4 Elite Analysis starting for OpenAI, Stage: Media Landscape Mapping
    ...
    🚀 V4 Elite Analysis starting for OpenAI, Stage: Regulatory Environment
    ...
    🚀 V4 Elite Analysis starting for OpenAI, Stage: Market Trends & Topic Analysis
    ...
    🚀 V4 Elite Analysis starting for OpenAI, Stage: Strategic Synthesis & Pattern Recognition
    🎯 Executing stage: synthesis
    📊 Synthesis stage - passing all previous results: Array(6)
    🔍 Synthesis - Intelligence data check: Object
    📊 Stage 7 (Strategic Synthesis & Pattern Recognition) FULL result: Object
    📊 Stage 7 (Strategic Synthesis & Pattern Recognition) result summary: Object
    🎯 ELABORATE PIPELINE - Stage trigger check: Object
    🎉 All stages done, completing pipeline...
    📊 Current state before completion: Object
    ✅ All stage results accumulated, proceeding with completion
    🎉 ELABORATE PIPELINE COMPLETE in 144 seconds
    📊 Final stage results: Array(7)
    📊 Stage results detail: Object
    🔄 ELABORATE SYNTHESIS: Combining insights from all stages...
    📊 Stage results structure: Array(7)
    📈 Extracted data from stages: Array(7)
    🔍 Synthesis stage data structure: Object
    📊 Extracted 5 total opportunities from all stages
    🔍 Synthesis stage data structure: Object
    📊 Extracted 5 total opportunities from all stages
    🔍 Synthesis stage data structure: Object
    📊 Extracted 5 total opportunities from all stages
    ✅ Elaborate intelligence synthesized: Object
    🎯 Setting final intelligence: Object
    🔍 Intelligence structure: Object
    ✅ Component marked as complete, should render results now
    📤 Calling onComplete callback with intelligence
    🎨 Rendering completed intelligence UI Object
    🎯 Rendering opportunities: Object
    🎨 RENDER TRIGGER: Both isComplete and finalIntelligence are set!
    Final intelligence available: Object
    🎨 Rendering completed intelligence UI Object
    🎯 Rendering opportunities: Object
    🎨 Rendering completed intelligence UI Object
    🎯 Rendering opportunities: Object
    ...
    🎨 Rendering completed intelligence UI Object
    🎯 Rendering opportunities: Object
    MultiStageIntelligence.js:1432 🎨 Rendering completed intelligence UI Object
    MultiStageIntelligence.js:1255 🎯 Rendering opportunities: Object
    MultiStageIntelligence.js:1432 🎨 Rendering completed intelligence UI Object
    MultiStageIntelligence.js:1255 🎯 Rendering opportunities: Object
    MultiStageIntelligence.js:1432 🎨 Rendering completed intelligence UI Object
    MultiStageIntelligence.js:1255 🎯 Rendering opportunities: Object
    ...
    MultiStageIntelligence.js:1432 🎨 Rendering completed intelligence UI Object
    MultiStageIntelligence.js:1255 🎯 Rendering opportunities: Object
    MultiStageIntelligence.js:1432 🎨 Rendering completed intelligence UI {isComplete: true, hasFinalIntelligence: true, finalIntelligenceKeys: Array(8)}
    MultiStageIntelligence.js:1255 🎯 Rendering opportunities: {count: 5, opportunities: Array(2), hasTabsData: true, tabKeys: Array(6)}
    MultiStageIntelligence.js:1432 🎨 Rendering completed intelligence UI {isComplete: true, hasFinalIntelligence: true, finalIntelligenceKeys: Array(8)}
    MultiStageIntelligence.js:1255 🎯 Rendering opportunities: {count: 5, opportunities: Array(2), hasTabsData: true, tabKeys: Array(6)}
    MultiStageIntelligence.js:1432 🎨 Rendering completed intelligence UI {isComplete: true, hasFinalIntelligence: true, finalIntelligenceKeys: Array(8)}
    MultiStageIntelligence.js:1255 🎯 Rendering opportunities: {count: 5, opportunities: Array(2), hasTabsData: true, tabKeys: Array(6)}
