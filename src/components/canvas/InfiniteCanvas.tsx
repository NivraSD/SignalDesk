...
const COMPONENT_TYPES: ComponentType[] = [
  ...
  { id: 'opportunities', label: 'Opportunities', icon: Target, color: 'from-purple-300 to-purple-500', defaultWidth: 800, defaultHeight: 600 },
  { id: 'execute', label: 'Execute', icon: Zap, color: 'from-purple-400 to-purple-600', defaultWidth: 800, defaultHeight: 600 },
  { id: 'workspace', label: 'Workspace', icon: FileEdit, color: 'from-purple-300 to-purple-500', defaultWidth: 900, defaultHeight: 700 },
  { id: 'campaign-planner', label: 'Campaign Planner', icon: TrendingUp, color: 'from-purple-400 to-purple-600', defaultWidth: 1000, defaultHeight: 800 },
  { id: 'memoryvault', label: 'Memory Vault', icon: Database, color: 'from-purple-500 to-purple-700', defaultWidth: 800, defaultHeight: 600 },
  { id: 'plan', label: 'Planning', icon: LayoutGrid, color: 'from-purple-400 to-purple-600', defaultWidth: 800, defaultHeight: 600 },
