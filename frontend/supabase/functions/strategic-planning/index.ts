...
2. Strategic Pillars (3-4 key focus areas with specific actions)
...
Each strategic_pillar should have: title, description, actions, timeline, mcp (which MCP will help execute this)
  ...
  try {
    ...
    try {
      ...
      strategicPlan = {
        ...
        evidence_needs: ['Market analysis', 'Competitor research', 'Customer insights'],
        ...
        success_metrics: ['Objective completion rate', 'Timeline adherence', 'Quality metrics'],
        risk_mitigation: [
