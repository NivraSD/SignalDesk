-- SignalDesk V2 MemoryVault Migration Script (Without Vector)
...
-- ========================================
-- CREATE MEMORY_VAULT TABLE (WITHOUT VECTOR)
-- ========================================

-- Check if memory_vault exists and create it
DO $$ 
BEGIN
...
BEGIN
    ...
    RAISE NOTICE '- memory_vault (created without vector column)';
