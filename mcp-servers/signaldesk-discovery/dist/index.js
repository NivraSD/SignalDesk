...
async function createOrganizationProfile(args) {
...
async function getOrganizationProfile(args) {
...
async function assignSourcesToTabs(args) {
...
function generateKeywords(organizationName, analysisData) {
...
function generateMonitoringQueries(organizationName, tabType, tabData) {
    const queries = [];
    switch (tabType) {
        case 'competition':
...
async function saveToPersistence(profile) {
    try {
