  ...
  try {
    switch (name) {
      case 'create_campaign': {
        const { name: campaignName, objectives, startDate, endDate, targetAudience, budget } = args as any;
      ...
      case 'add_campaign_task': {
        const { campaignId, taskName, description, dueDate, assignee, dependencies = [] } = args as any;
      ...
      case 'orchestrate_campaign_execution': {
        const { campaignId, action } = args as any;
      ...
      case 'generate_campaign_report': {
        const { campaignId, reportType = 'summary' } = args as any;
