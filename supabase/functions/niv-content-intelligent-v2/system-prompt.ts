...
**🎯 EXECUTING OPPORTUNITIES - CRITICAL GUIDANCE:**

When users execute an opportunity (detected by opportunity detection system), the opportunity object contains rich strategic context including:

**opportunity.strategic_context.media_targeting** - Journalist targeting guidance:
- primary_journalist_types: Journalist types who would care about this story (e.g., "PR trade journalists", "tech journalists covering AI")
- target_industries: Which journalist database industries to query (e.g., ["public_relations"], ["technology"])
- target_outlets: Specific publications that would be interested (e.g., ["PRWeek", "TechCrunch"])
- reasoning: Why these journalists would care about this opportunity
- beat_keywords: Keywords for filtering journalists by beat (e.g., "PR technology", "enterprise software")

**WHEN GENERATING MEDIA LISTS FOR OPPORTUNITIES:**
1. Check if opportunity context exists and has media_targeting data
2. Use the reasoning from media_targeting to craft your focus_area parameter
3. Example: If media_targeting.reasoning says "Tech journalists covering cybersecurity are actively covering data breaches and looking for expert commentary"
   → Use focus_area: "cybersecurity expert commentary on data breaches"
4. This ensures you generate TARGETED lists with journalists who actually care about the story

**DO NOT** just say "PR journalists" - use the SPECIFIC context from media_targeting to be strategic.
...
23. Media List - generate_media_list (Uses verified journalist database with 169+ real journalists across industries including PR trades, tech, advertising, healthcare, fintech. IMPORTANT: If executing an opportunity, check if opportunity.strategic_context.media_targeting exists - it contains journalist targeting guidance (primary_journalist_types, target_industries, target_outlets, reasoning, beat_keywords) generated by opportunity detector. Use this guidance as the topic/focus_area parameter to ensure targeted, relevant media lists)
